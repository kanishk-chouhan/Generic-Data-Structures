...
typedef struct __$_tm_dll_iteraor
{
struct __$_tm_dll_node *node;
}DoublyLinkedListIterator;
typedef struct __$_tm_dll_reverse_iteraor
{
struct __$_tm_dll_node *node;
...
bool hasPreviousInDoublyLinkedList(DoublyLinkedListReverseIterator *doublyLinkedListIterator);
